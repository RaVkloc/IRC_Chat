from xcomm.xcomm_moduledefs import MESSAGE_ACTION, MESSAGE_ACTION_LOGIN_CODE, MESSAGE_ACTION_REGISTER_CODE, \
    ...
    MESSAGE_ACTION_LEAVEROOM_CODE, MESSAGE_ACTION_LOGOUT_CODE, MESSAGE_ACTION_SENDMESSAGE_CODE, \
...
from xserver.actionsserver.list_users_action import ListUsersAction
...
class ActionProvider:
    action_dict = {
        MESSAGE_ACTION_LOGIN_CODE: LoginAction,
        ...
        MESSAGE_ACTION_SENDMESSAGE_CODE: SendMessageAction,
        MESSAGE_ACTION_LEAVEROOM_CODE: LeaveRoomAction,
        MESSAGE_ACTION_LOGOUT_CODE: LogoutAction,
        MESSAGE_ACTION_LISTUSERS_CODE: ListUsersAction
    }
